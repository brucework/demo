...
sudo mount -t cifs //172.16.2.225/flash /mnt/flash_225 -o username=$USER,password=T123.blw,domain=smartisan.cn

echo "mount 172.16.26.22 to /mnt/flash_22"
sudo mount -t cifs //172.16.26.22/flash /mnt/flash_22 -o username=bspsystem,password=bspsystem
