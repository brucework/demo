...
#include "/home/bruce/work/demo/src/python/tool/opencv-3.3.0/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/home/bruce/work/demo/src/python/tool/opencv-3.3.0/modules/dnn/include/opencv2/dnn/all_layers.hpp"
#include "/home/bruce/work/demo/src/python/tool/opencv-3.3.0/modules/dnn/include/opencv2/dnn/dnn.hpp"
#include "/home/bruce/work/demo/src/python/tool/opencv-3.3.0/modules/dnn/include/opencv2/dnn/dict.hpp"
...
//
//  Mat blobFromImage(Mat image, double scalefactor = 1.0, Size size = Size(), Scalar mean = Scalar(), bool swapRB = true)
//



JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Dnn_blobFromImage_10 (JNIEnv*, jclass, jlong, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jboolean);
...
//
//  Mat blobFromImages(vector_Mat images, double scalefactor = 1.0, Size size = Size(), Scalar mean = Scalar(), bool swapRB = true)
//



JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Dnn_blobFromImages_10 (JNIEnv*, jclass, jlong, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jboolean);
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Dnn_readNetFromTensorflow_10 (JNIEnv*, jclass, jstring);
...
//
//  vector_Ptr_Layer getLayerInputs(LayerId layerId)
//

using namespace cv::dnn;

JNIEXPORT jobject JNICALL Java_org_opencv_dnn_Net_getLayerInputs_10 (JNIEnv*, jclass, jlong, jlong);

JNIEXPORT jobject JNICALL Java_org_opencv_dnn_Net_getLayerInputs_10
  (JNIEnv* env, jclass , jlong self, jlong layerId_nativeObj)
{
    static const char method_name[] = "dnn::getLayerInputs_10()";
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        std::vector< Ptr<cv::dnn::Layer> > _ret_val_vector_ = me->getLayerInputs( (*(cv::dnn::DictValue*)layerId_nativeObj) );
        jobject _retval_ = vector_Ptr_Layer_to_List(env, _ret_val_vector_);
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  void getLayerShapes(MatShape netInputShape, int layerId, vector_MatShape* inLayerShapes, vector_MatShape* outLayerShapes)
//

using namespace cv::dnn;

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayerShapes_10 (JNIEnv*, jclass, jlong, jlong, jint, jobject, jobject);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayerShapes_10
  (JNIEnv* env, jclass , jlong self, jlong netInputShape_mat_nativeObj, jint layerId, jobject inLayerShapes_list, jobject outLayerShapes_list)
{
    static const char method_name[] = "dnn::getLayerShapes_10()";
    try {
        LOGD("%s", method_name);
        MatShape netInputShape;
        Mat& netInputShape_mat = *((Mat*)netInputShape_mat_nativeObj);
        ...
        inLayerShapes = List_to_vector_MatShape(env, inLayerShapes_list);
        std::vector< MatShape > outLayerShapes;
        outLayerShapes = List_to_vector_MatShape(env, outLayerShapes_list);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getLayerShapes( netInputShape, (int)layerId, &inLayerShapes, &outLayerShapes );
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  void getLayerShapes(vector_MatShape netInputShapes, int layerId, vector_MatShape* inLayerShapes, vector_MatShape* outLayerShapes)
//

using namespace cv::dnn;

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayerShapes_11 (JNIEnv*, jclass, jlong, jobject, jint, jobject, jobject);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayerShapes_11
  (JNIEnv* env, jclass , jlong self, jobject netInputShapes_list, jint layerId, jobject inLayerShapes_list, jobject outLayerShapes_list)
{
    static const char method_name[] = "dnn::getLayerShapes_11()";
    try {
        LOGD("%s", method_name);
        std::vector< MatShape > netInputShapes;
        netInputShapes = List_to_vector_MatShape(env, netInputShapes_list);
        ...
        outLayerShapes = List_to_vector_MatShape(env, outLayerShapes_list);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getLayerShapes( netInputShapes, (int)layerId, &inLayerShapes, &outLayerShapes );
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  void getMemoryConsumption(MatShape netInputShape, vector_int& layerIds, vector_size_t& weights, vector_size_t& blobs)
//

using namespace cv::dnn;

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_11 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_11
  (JNIEnv* env, jclass , jlong self, jlong netInputShape_mat_nativeObj, jlong layerIds_mat_nativeObj, jlong weights_mat_nativeObj, jlong blobs_mat_nativeObj)
{
    ...
    try {
        ...
        Mat& layerIds_mat = *((Mat*)layerIds_mat_nativeObj);
        std::vector<size_t> weights;
        Mat& weights_mat = *((Mat*)weights_mat_nativeObj);
        std::vector<size_t> blobs;
        Mat& blobs_mat = *((Mat*)blobs_mat_nativeObj);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getMemoryConsumption( netInputShape, layerIds, weights, blobs );
        vector_int_to_Mat( layerIds, layerIds_mat );  vector_size_t_to_Mat( weights, weights_mat );  vector_size_t_to_Mat( blobs, blobs_mat );
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_13 (JNIEnv*, jclass, jlong, jint, jobject, jdoubleArray, jdoubleArray);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_13
  (JNIEnv* env, jclass , jlong self, jint layerId, jobject netInputShapes_list, jdoubleArray weights_out, jdoubleArray blobs_out)
{
    static const char method_name[] = "dnn::getMemoryConsumption_13()";
    try {
        LOGD("%s", method_name);
        std::vector< MatShape > netInputShapes;
        netInputShapes = List_to_vector_MatShape(env, netInputShapes_list);
...
//
//  void getMemoryConsumption(vector_MatShape netInputShapes, size_t& weights, size_t& blobs)
//

using namespace cv::dnn;

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_14 (JNIEnv*, jclass, jlong, jobject, jdoubleArray, jdoubleArray);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_14
  (JNIEnv* env, jclass , jlong self, jobject netInputShapes_list, jdoubleArray weights_out, jdoubleArray blobs_out)
{
    static const char method_name[] = "dnn::getMemoryConsumption_14()";
    try {
        LOGD("%s", method_name);
        std::vector< MatShape > netInputShapes;
        netInputShapes = List_to_vector_MatShape(env, netInputShapes_list);
        ...
        size_t weights;
        size_t blobs;
        me->getMemoryConsumption( netInputShapes, weights, blobs );
        jdouble tmp_weights[1] = {(jdouble)weights}; env->SetDoubleArrayRegion(weights_out, 0, 1, tmp_weights);  jdouble tmp_blobs[1] = {(jdouble)blobs}; env->SetDoubleArrayRegion(blobs_out, 0, 1, tmp_blobs);
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
//
//  void getMemoryConsumption(vector_MatShape netInputShapes, vector_int& layerIds, vector_size_t& weights, vector_size_t& blobs)
//

using namespace cv::dnn;

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_15 (JNIEnv*, jclass, jlong, jobject, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_15
  (JNIEnv* env, jclass , jlong self, jobject netInputShapes_list, jlong layerIds_mat_nativeObj, jlong weights_mat_nativeObj, jlong blobs_mat_nativeObj)
{
    static const char method_name[] = "dnn::getMemoryConsumption_15()";
    try {
        LOGD("%s", method_name);
        std::vector< MatShape > netInputShapes;
        netInputShapes = List_to_vector_MatShape(env, netInputShapes_list);
        ...
        Mat& blobs_mat = *((Mat*)blobs_mat_nativeObj);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getMemoryConsumption( netInputShapes, layerIds, weights, blobs );
        vector_int_to_Mat( layerIds, layerIds_mat );  vector_size_t_to_Mat( weights, weights_mat );  vector_size_t_to_Mat( blobs, blobs_mat );
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
