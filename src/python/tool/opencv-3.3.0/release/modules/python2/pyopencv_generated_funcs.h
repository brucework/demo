...
static PyObject* pyopencv_cv_CirclesGridFinderParameters_CirclesGridFinderParameters(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;

    pyopencv_CirclesGridFinderParameters_t* self = 0;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        self = PyObject_NEW(pyopencv_CirclesGridFinderParameters_t, &pyopencv_CirclesGridFinderParameters_Type);
...
static PyObject* pyopencv_cv_dnn_dnn_DictValue_DictValue(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::dnn;

    {
    int i=0;
    pyopencv_dnn_DictValue_t* self = 0;

    const char* keywords[] = { "i", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:DictValue", (char**)keywords, &i) )
    {
        self = PyObject_NEW(pyopencv_dnn_DictValue_t, &pyopencv_dnn_DictValue_Type);
...
static PyObject* pyopencv_cv_dnn_blobFromImage(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "image", "scalefactor", "size", "mean", "swapRB", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|dOOb:blobFromImage", (char**)keywords, &pyobj_image, &scalefactor, &pyobj_size, &pyobj_mean, &swapRB) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) )
    {
        ERRWRAP2(retval = cv::dnn::blobFromImage(image, scalefactor, size, mean, swapRB));
        return pyopencv_from(retval);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_dnn_blobFromImages(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "images", "scalefactor", "size", "mean", "swapRB", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|dOOb:blobFromImages", (char**)keywords, &pyobj_images, &scalefactor, &pyobj_size, &pyobj_mean, &swapRB) &&
        pyopencv_to(pyobj_images, images, ArgInfo("images", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) )
    {
        ERRWRAP2(retval = cv::dnn::blobFromImages(images, scalefactor, size, mean, swapRB));
        return pyopencv_from(retval);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_dnn_createTensorflowImporter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:createTensorflowImporter", (char**)keywords, &pyobj_model) &&
...
static PyObject* pyopencv_cv_dnn_readNetFromTensorflow(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "model", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:readNetFromTensorflow", (char**)keywords, &pyobj_model) &&
        pyopencv_to(pyobj_model, model, ArgInfo("model", 0)) )
    {
        ERRWRAP2(retval = cv::dnn::readNetFromTensorflow(model));
        return pyopencv_from(retval);
    }
